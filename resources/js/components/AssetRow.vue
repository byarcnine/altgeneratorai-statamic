    ...
    <tr>
        ...
        <td>
            ...
            <div v-else-if="isGenerating" class="alt-text-skeleton">
                <div>
                    <div
                        class="h-3 bg-gray-300 rounded w-full mb-2 skeleton-pulse"
                    ></div>
                    <div
                        class="h-3 bg-gray-300 rounded w-5/6 mb-2 skeleton-pulse"
                    ></div>
                    <div
                        class="h-3 bg-gray-300 rounded w-4/6 skeleton-pulse"
                    ></div>
                </div>
            </div>
        </td>
